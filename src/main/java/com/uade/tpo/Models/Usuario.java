...
public class Usuario {
    ...
    public Enums.TipoDeporte getDeporteFav() { return deporteFav; }
    public void setDeporteFav(Enums.TipoDeporte deporteFav) { this.deporteFav = deporteFav; }

    public Enums.TipoNivelDeJuego getNivelJuego() { return nivelJuego; }
    public void setNivelJuego(Enums.TipoNivelDeJuego nivelJuego) { this.nivelJuego = nivelJuego; }

    public Zona getUbicacion() { return ubicacion; }
    public void setUbicacion(Zona ubicacion) { this.ubicacion = ubicacion; }

    public IEmparejamiento getMetodoEmparejamiento() { return metodoEmparejamiento; }
